    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="ManageBus.jsp" class="nav-link">Buses</a></li>
                <li class="nav-item"><a href="ManageRoute.jsp" class="nav-link"> Routes</a></li>
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
        <div class="col-md-9 ftco-animate pb-5">
            <div class="container">
                ...
                <p class="breadcrumbs"><span class="mr-2"><a href="Home.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Welcome <i class="ion-ios-arrow-forward"></i></span></p>
