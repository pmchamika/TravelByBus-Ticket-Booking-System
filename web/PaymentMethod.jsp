    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" style="margin-top: 7vh">
        <div class="col-md-9 ftco-animate pb-5">
            <div class="container">
                ...
                <h1 class="mb-3 bread">Set up a new payment method</h1>
                <p class="breadcrumbs"><span class="mr-2"><a href="Home.jsp">Home <i class="ion-ios-arrow-forward"></i></a></span>
                    <span>Payment Method <i class="ion-ios-arrow-forward"></i></span></p>

                <span style="color: white">You will need to have an option ready to accept payouts you earn from selling </span>
                <br/><br/>
