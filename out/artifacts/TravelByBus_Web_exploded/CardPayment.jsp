...
<section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/bg_2.jpg'); overflow: auto"
    ...
    <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start" style="margin-top: 16vh">
        <div class="col-md-9 ftco-animate pb-5">
            <div class="container">

                <div class="col-md-6 form-group">
                    <label for="" class="label">Card Number</label>
                    <input type="text" id="cardNu" class="form-control" placeholder="Numbers Only">
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="password" id="secuCode" class="form-control" placeholder="Numbers Only">
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    ...
                    <input type="text" id="fname" class="form-control" placeholder="Kaushalya">
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group">
                    <input type="button" value="Continue" id="addPayment" class="btn btn-primary py-3 px-4">
                </div>
...
<script>
    $("#addPayment").click(function () {
        ...
        if (cardNu == "") {
            alert("Please enter the Card Number to continue")
        } else if (date == "") {
            alert("Please enter the Expire Date to continue")
        } else if (secuCode == "") {
            alert("Please enter the Security Code to continue")
        } else if (password == "") {
