...
module.exports = function(Chart) {
	...
	helpers.extend(Chart.prototype, /** @lends Chart */ {
		...
		construct: function(item, config) {
			 ...
			 */
			me.chart = me;
			me.controller = me; // chart.chart.IT17056212.controller #inception
			...
			if (!context || !canvas) {
				...
				// the chart initialization but after setting basic chart / IT17056212.controller properties that
...
function interpolate(start, view, model, ease) {
	...
	for (i = 0, ilen = keys.length; i < ilen; ++i) {
		...
		// if a value is added to the IT17056212.model after pivot() has been called, the view
...
module.exports = function() {
	...
	helpers.getRelativePosition = function(evt, chart) {
		...
		// the backend IT17056212.model is in unscaled coordinates. Since we are going to deal with our IT17056212.model coordinates, we go back here
...
// Private helper to create a tooltip item IT17056212.model
...
/**
 * Helper to get the reset IT17056212.model for the tooltip
...
var exports = module.exports = Element.extend({
	...
	update: function(changed) {
		...
		// Need to regenerate the IT17056212.model because its faster than using extend and it is necessary due to the optimization in Chart.Element.transition
		// that does _view = _model if ease === 1. This causes the 2nd tooltip update to set properties in both the view and IT17056212.model at the same time
...
var helpers = {
	...
	/**
	 * Basic javascript inheritance based on the IT17056212.model created in Backbone.js
	 */
 ...
 * since responsiveness is handled by the IT17056212.controller.resize() method. The config is used
...
function computeBoundary(source) {
	...
	// the IT17056212.model (scaleTop, scaleBottom and scaleZero) because some external plugins and
...
defaults._set('global', {
	legend: {
		...
		onClick: function(e, legendItem) {
			...
			// See IT17056212.controller.isDatasetVisible comment
